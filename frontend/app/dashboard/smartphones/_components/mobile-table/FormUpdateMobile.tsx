...
export default function FormUpdateMobile({locations=[], employees=[], devices, departments=[],onClose}:Props){
           ...
           <div className="flex items-center gap-2 mb-4 text-slate-700">
            ...
            <Autocomplete name="employee" label= "Selecciona un Empleado" placeholder="Escribe para buscar..." className="flex-1 bg-white rounded-2xl" defaultItems={employees}variant="bordered"
                 selectedKey={employeeId || null} onSelectionChange={(key) => setEmployeeId(key as string)} inputValue={employeeInput} onInputChange={setEmployeeInput}>
                    ...
                    <SelectItem key="BAJA" color="danger" variant="flat" description="El Dispositivo ya es obsoleto o está dañado.">
                        BAJA
                    </SelectItem>
                    <SelectItem key="Asignado" color="default" variant="flat" description="El Dispositivo ha sido asignado a un Empleado.">
                        Asignado
                    </SelectItem>
                    </Select>
