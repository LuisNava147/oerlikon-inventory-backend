...
export default function SearchMobile() {
    ...
    // 1. BLINDAJE: Si 'f' viene vacío o null, usamos 'model'
    const initialFilter = searchParams.get("f") || "brand";
    ...
    const handleSearch = () => {
        if (!query.trim()) {
            router.push("/dashboard/smartphones");
        } else {
            router.push(`/dashboard/smartphones?q=${encodeURIComponent(query)}&f=${filter}`);
        }
    };
        ...
        <div className="flex flex-col md:flex-row gap-3 bg-white p-4 rounded-xl shadow-sm border border-slate-100 items-end md:items-center">
            ...
            <div className="w-full md:w-56">
                ...
                >
                    ...
                    <SelectItem key="model">Modelo</SelectItem>
