...
export default function UpdateMobile({locations, employees, devices}:{locations: Location[], employees: Employee[], devices: Device}){
            ...
            <ModalContent className="w-full h-[90vh] md:h-auto max-h-[90vh]">
                {
                    ()=>(
                        ...
                        <ModalBody className="py-7 overflow-y-auto">
                            <FormUpdateMobile employees={employees} locations={locations} devices={devices} onClose={onOpenChange}/>
                        </ModalBody>
                        </>
                    )
                }
