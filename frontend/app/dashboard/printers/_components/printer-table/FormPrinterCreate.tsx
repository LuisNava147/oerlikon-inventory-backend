...
export default function FormCreatePrinter({locations, departments, onClose}:{locations: Location[], departments: Deparment[], onClose: ()=>void}){
    ...
    return(
        <form action={formAction} className="bg-slate-50 p-8 rounded-none flex flex-col gap-2">
            ...
            <Input isRequired label="Marca del Dispositivo" placeholder="Ej. Konica" variant="bordered" name="deviceBrand" className="mb-3 bg-white rounded-2xl"/>
            <Input isRequired label="Modelo" placeholder="Ej. BizHub 4050" variant="bordered" name="deviceModel" className="mb-3 bg-white rounded-2xl"/>
            <Input label="Hostname" placeholder="Ej. PD02QT01238" variant="bordered" name="deviceHostName" className="mb-3 bg-white rounded-2xl" />
            ...
            <Input label="Dirección IP" placeholder="Ej. 10.52.0.0" variant="bordered" name="ipAddress" className="mb-3 bg-white rounded-2xl" />
            <Input label="Nombre en SAP" placeholder="Ej. MX90" variant="bordered" name="sapName" className="mb-3 bg-white rounded-2xl" />
            <Input label="Dirección MAC" variant="bordered" name="deviceMAC" className="mb-3 bg-white rounded-2xl" />
            </div>
